  ...
  return (
    <div className="bg-[#143DDB] h-full">
      ...
      <div className="flex flex-wrap items-center justify-center">
        <PoolCard title="CHAPEAU 1" teams="France" />
        <PoolCard title="CHAPEAU 2" teams="France" />
        <PoolCard title="CHAPEAU 3" teams="France" />
        <PoolCard title="CHAPEAU 4" teams="France" />
      </div>
      <div
        className="bg-cover flex items-center justify-center"
        style={{ backgroundImage: `url(${footerImage})`, height: 317 }}
      >
